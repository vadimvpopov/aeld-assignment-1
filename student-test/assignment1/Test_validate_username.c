...
void test_validate_my_username()
{
    ...
    const char *conf_username_value = malloc_username_from_conf_file();
    TEST_ASSERT_EQUAL_STRING_MESSAGE(my_username_value, conf_username_value, "The usernames do not match");
